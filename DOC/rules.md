...
- [Pravidla hry](#pravidla-hry)
  ...
  - [Tah Hráče](#tah-hráče)
    - [Pohyb](#pohyb)
    - [Boj](#boj)
    - [Nákup modulů od obchodníka](#nákup-modulů-od-obchodníka)
...
Lehké a levné moduly. Dřevěný trup tě nezatíží, ale celková kapacita a odolnost v boji je mizerná.

Epocha II (Pára a Železo):
Nastupuje průmyslová revoluce. Železné nýtované pláty a parní kotle. Tyhle moduly mají obrovský výkon a kapacitu, ale jejich zátěž je tak velká, že k nim musíš připojit odpovídající pohon, jinak se vůbec nepohneš.

Epocha III (Ocel):
Masivní ocelové dreadnoughty. Extrémně drahé moduly s obrovským výkonem, které ti umožní přejet mapu za jeden tah a odvézt velké množství nákladu.
...
Suroviny je možné nakládat a vykládat z dopravního přostředku, který stojí ve městě. Pokud se vám nehodí aktuální náklad, můžete ho vyložit v libovolném městě.
...
Vylepšení města:
- efektivita (město produkuje 2x tolik surovin),
- rozšíření výroby (přidej další surovinu).

Hráč položí na dané město na mapě "Upgrade žeton". Od tohoto momentu město při svém hodu na kostce produkuje dvojnásobek.
 
Při rozšíření vyroby hráč sáhne do pytlíku a yvlosuje žeton produkce suroviny, který se přidá k městu. Od tohoto momentu se při hodu na kostce v tomto městě produkují dvě různé suroviny.
...
- Fáze produkce (Svět): Hráč hodí dvěma kostkami. Do měst, jejichž čísla padlo, se přidá tolik surovin, jaká je úroveň jejich vylepšení (standardně 1 kostička).
...
### Nákup modulů od obchodníka

Jsou vyložené moduly lícem vzhůru, které hráči mohou ve svém tahu koupit.

Cena modulů v Epochách:
- Epocha 1: 5
- Epocha 2: 10
- Epocha 3: 20

Cena se platí za karty mudulů v ruce, nebo splněnými úkoly.


Pokud si za úkol koupím modul na tržišti, tak se úkol může vrátit zpátky do balíčku úkolu (pokud jsme se nedostali do další fáze hry)
- Upgrade - karty se při prodání z ruky vyřadí ze hry. 

### Obchod mezi hráči

Hráči, jejichž stroje se nacházejí na stejném hexu, mohou směnovat suroviny převážené na těchto strojích.

Hráč ve svém tahu může vyměnovat vylepšení, které má v ruce s ostatními hráči. 

Použití města jako překladiště

Pokud hráči nejsou na stejném místě ve stejný čas. Každé město má prostor na uložení vyrobených surovin, tento prostor lze použít jako odkládací prostor pro dopravní prostředek, který tímto místem prochází.
Můžete tam ve svém tahu složit suroviny ve městě a kdykoliv později tam může přijet jiný hráč, a vyzvednout si je (v rámci obchodu, nebo je ukrást). Zboží tak může na mapě rotovat nezávisle na přesném načasování tahů.
